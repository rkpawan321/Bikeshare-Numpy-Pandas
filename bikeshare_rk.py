...
def get_city():
    ...
    city = input('\nHello! Let\'s explore some US bikeshare data!\n'
                     'Which city\'s data would you like to see ? - Chicago, New York, or'
                     ' Washington?\n')
...
def statistics():
    ...
    # Filter by time period that the user specifies (month, day, both)
    ...
    if filter_period == 'both' or filter_period == 'day':
        print(popular_month(filtered_df))

    # What is the most popular day of week (Monday, Tuesday, etc.) for start time?
    if filter_period == 'both' or filter_period == 'month':
